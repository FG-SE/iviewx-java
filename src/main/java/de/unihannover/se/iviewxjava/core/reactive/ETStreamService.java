package de.unihannover.se.iviewxjava.core.reactive;

import de.unihannover.se.iviewxjava.core.receiver.response.ETResponseType;
import de.unihannover.se.iviewxjava.exception.ETStreamException;
 ...
 *  with data from a {@link ETReceiver} by leveraging
...
public class ETStreamService<E extends ChronologicComparable<E>> {
	...
	/** Stops the service.
	 *  
	 *  @throws ETStreamException if a timeout occurs when stopping the service
	 */
	public void stop() {
		stopStreamThread();
	}
