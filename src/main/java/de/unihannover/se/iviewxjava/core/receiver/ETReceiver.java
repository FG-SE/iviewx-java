...
public abstract class ETReceiver<E extends ChronologicComparable<E>> {
	...
	/** Returns the next item from the data source wrapped in a {@link ETResponse}.
	 *  <p>
	 ...
	 * 
	 *  @return Next data item wrapped in a {@link ETResponse}
	 */
	 ...
	 *  according to the currently set {@link ETStabilizationStrategy}.
	 * 
	 *  @return Next stabilized data item wrapped in a {@link ETResponse}
	 */
