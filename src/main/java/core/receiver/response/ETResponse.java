...
/** Wraps the response of a {@link core.receiver.ETReceiver},
 *  adding additional information.
 *  <p>
 *  Besides the data, a response also contains a
 *  {@link core.receiver.response.ETResponseType}, making it easier
 *  to use the data returned by a receiver, if an
 *  edge case occurs.
 *  <p>
 *  A usual pattern is to return actual data together
 *  with the {@link core.receiver.response.ETResponseType#NEW_DATA NEW_DATA},
 *  or <strong>null</strong> together with a reasonable
 *  response type.
 *  
 *  @see core.receiver.response.ETResponseType
 * 
