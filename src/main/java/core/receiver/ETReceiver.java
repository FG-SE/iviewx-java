...
public abstract class ETReceiver<E extends ChronologicComparable<E>> {
	...
	/** Returns the next item from the data source wrapped in a {@link core.receiver.response.ETResponse}.
	 *  <p>
	 ...
	 * 
	 *  @return Next data item wrapped in a {@link core.receiver.response.ETResponse}
	 */
	 ...
	 *  according to the currently set {@link core.receiver.stabilization.ETStabilizationStrategy}.
	 * 
	 *  @return Next stabilized data item wrapped in a {@link core.receiver.response.ETResponse}
	 */
